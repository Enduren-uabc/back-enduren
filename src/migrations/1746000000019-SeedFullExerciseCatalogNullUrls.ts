  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const exercises = [
      ...
      },
      {
        ...
        category: 'chest',
        primaryMuscleGroup: 'Pectoral Inferior',
        equipment: 'barbell',
      },
      {
      ...
      },
      {
        ...
        category: 'back',
        primaryMuscleGroup: 'Erectores Espinales',
        equipment: 'barbell',
      },
      {
      ...
      },
      {
        ...
        name: 'Hiperextensiones en banco de 45 grados',
        category: 'back',
        primaryMuscleGroup: 'Erectores Espinales',
        equipment: 'machine',
      },
      {
        ...
        category: 'shoulders',
        primaryMuscleGroup: 'Deltoides Anterior',
        equipment: 'barbell',
      },
      {
      ...
      },
      {
        ...
        category: 'shoulders',
        primaryMuscleGroup: 'Deltoides Medio',
        equipment: 'dumbbell',
      },
      {
      ...
      },
      {
        ...
        category: 'arms',
        primaryMuscleGroup: 'Bíceps Braquial',
        equipment: 'barbell',
      },
      {
      ...
      },
      {
        ...
        category: 'arms',
        primaryMuscleGroup: 'Braquiorradial',
        equipment: 'barbell',
      },
      {
      ...
      },
      {
        ...
        category: 'arms',
        primaryMuscleGroup: 'Tríceps Braquial',
        equipment: 'barbell',
      },
      {
      ...
      },
      {
        ...
        name: 'Jalón de tríceps con barra recta',
        category: 'arms',
        primaryMuscleGroup: 'Tríceps Braquial',
        equipment: 'cable',
      },
      ...
      },
      {
        ...
        name: 'Zancadas inversas con mancuernas',
        category: 'legs',
        primaryMuscleGroup: 'Glúteo Mayor',
        equipment: 'dumbbell',
      },
      {
      ...
      },
      {
        ...
        name: 'Peso muerto con piernas rígidas con mancuernas',
        category: 'legs',
        primaryMuscleGroup: 'Isquiotibiales',
        equipment: 'dumbbell',
      },
      ...
      },
      {
        ...
        category: 'legs',
        primaryMuscleGroup: 'Glúteo Medio',
        equipment: 'machine',
      },
      {
      ...
      },
      {
        ...
        category: 'legs',
        primaryMuscleGroup: 'Gastrocnemio',
        equipment: 'machine',
      },
      {
      ...
      },
      {
        ...
        category: 'core',
        primaryMuscleGroup: 'Recto Abdominal',
        equipment: 'machine',
      },
      {
      ...
      },
      {
        ...
        category: 'core',
        primaryMuscleGroup: 'Transverso Abdominal',
        equipment: 'bodyweight',
      },
      {
      ...
      },
      {
        ...
        category: 'core',
        primaryMuscleGroup: 'Core Estabilizador',
        equipment: 'dumbbell',
      },
      {

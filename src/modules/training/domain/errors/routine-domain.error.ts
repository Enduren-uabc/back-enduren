...
export enum RoutineErrorCode {
  ...
  ROUTINE_DAY_NOT_FOUND = 'ROUTINE_DAY_NOT_FOUND',
  ROUTINE_CANNOT_REMOVE_LAST_DAY = 'ROUTINE_CANNOT_REMOVE_LAST_DAY',
  ROUTINE_TARGET_AUDIENCE_FORBIDDEN = 'ROUTINE_TARGET_AUDIENCE_FORBIDDEN',
